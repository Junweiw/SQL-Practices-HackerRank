...
## Question List
### Basic Select - Easy
[Revising the Select Query I](#revising-the-select-query-i) | [Revising the Select Query II](#revising-the-select-query-ii) | [Select All](#select-all) | [Select By ID](#select-by-id) | [Japanese Cities' Attributes](#japanese-cities-attributes) | Japanese Cities' Names | Weather Observation Stations 1 | Weather Observation Stations 3 | Weather Observation Stations 4 | Weather Observation Stations 5 | Weather Observation Stations 6 | Weather Observation Stations 7 | Weather Observation Stations 8 | Weather Observation Stations 9 | Weather Observation Stations 10 | Weather Observation Stations 11 | Weather Observation Stations 12 | Higher Than 75 Marks | Employee Names | Employee Salaries
